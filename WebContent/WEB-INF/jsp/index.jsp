...
<!--顶部-->
	<div class="top">
    	<div class="top_center">
            <ul class="top_bars">
            	<li><a href="login">Login&nbsp;${sessionScope.customer.name }</a>|</li>
                <li><a href="saveOrder">我的订单<span class="jt_down"></span></a>|</li>
        	...
        	<div class="c3_b1_left">
            	<dl>
            		<c:forEach items="${applicationScope.category }" var="cate">
                    	...
                    	<p>
                    		<!-- 遍历小分类 -->
                    		<c:forEach items="${cate.category }" var="temp">
                    			<a href="listBook?categoryId=${temp.id }">${temp.id }.${temp.name }</a>
                    		</c:forEach>
                      	</p>
                    </dd>
            		</c:forEach>
