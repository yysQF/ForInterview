...
<body>
    ...
    <div class="content">
		...
		<form action="saveList" name="orderForm">
    		...
    		<div class="centerTop">
    			...
    			<ul class="adres" style="margin-top:20px;">			
			    		<li style="padding:5px">
			    			<input type="radio" name="shipAddId" style="width:16px;">
			    			<div class="addtest" style="padding:6px;line-height:25px;">
			    			${sessionScope.customer.name }&nbsp;&nbsp;&nbsp;${sessionScope.customer.telephone }&nbsp;&nbsp;
			    			&nbsp;${sessionScope.customer.address.country }-${sessionScope.customer.address.city }-
			    			${sessionScope.customer.address.street }</div>
			    		</li>
			    		<li style="padding:5px">
			    			<input type="radio" name="shipAddId" style="width:16px;">
			    			<div class="addtest" style="padding:6px;line-height:25px;">用户名&nbsp;&nbsp;&nbsp;手机号&nbsp;&nbsp;
			    			&nbsp;国家-城市-街道</div>
			    		</li>
		    	</ul>
    			...
    			<p id="newAdres" style="font-size:15px;display: none;">
					...
					收件人地址：<br>
					<input type="text" name="country" placeholder="国家"><br/> 
					<input type="text" name="city" placeholder="城市"><br/>
					<input type="text" name="street" placeholder="街道"><br/>
				</p>
    		</div>

    		<p class="singleP"><b>送货清单</b><span><a href="shopCar">返回修改购物车</a></span></p>
    		<div class="bigDiv">
    			<div class="twoDiv">
    				<b>商家：briup自营</b>
					...
					<ul class="oneUL">
    					<li>
    						...
    						<p>大分类&nbsp;&nbsp;${entry.value.book.description }&nbsp;&nbsp;${entry.value.book.name }&nbsp;&nbsp;</p>
    						<p><font>${entry.value.book.price }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${entry.value.num }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
    		...
    		<div class="money">
    			<span><font>${sessionScope.shopCar.num }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${sessionScope.shopCar.cost }</span>
